...
Singleton {
    ...
    readonly property color panelBackground: isDark ? "#282823" : "#ffffff"
    ...
    function hashColor(str) {
        if (!str || str === "")
            return isDark ? Colors.blueGrey300 : Colors.blueGrey400;
        if (_hashCache[str + isDark])
            return _hashCache[str + isDark];
        ...
        var palette = isDark ? [Colors.teal200, Colors.lightBlue200, Colors.green200, Colors.purple200, Colors.orange200, Colors.pink200, Colors.yellow200, Colors.cyan200, Colors.deepPurple200, Colors.blueGrey300] : [Colors.teal300, Colors.lightBlue300, Colors.green400, Colors.purple300, Colors.orange300, Colors.pink300, Colors.yellow700, Colors.cyan300, Colors.deepPurple300, Colors.blueGrey400];
