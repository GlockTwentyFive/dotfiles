...
PopupBase {
    ...
    SequentialAnimation {
        ...
        ParallelAnimation {
            ...
            NumberAnimation {
                target: gridTrans
                property: "x"
                to: monthAnim.direction > 0 ? -30 : 30
                duration: 80
                easing.type: Easing.OutCubic
            }
        }
        ...
        PropertyAction {
            target: gridTrans
            property: "x"
            value: monthAnim.direction > 0 ? 30 : -30
        }
        ParallelAnimation {
            NumberAnimation {
                target: dayGrid
    ...
    Column {
        ...
        Column {
            ...
            Repeater {
                model: Math.ceil((_firstWeekday(root._viewYear, root._viewMonth) + _daysInMonth(root._viewYear, root._viewMonth)) / 7)
                ...
                delegate: Rectangle {
                    ...
                    readonly property bool isCurrentWeek: {
                        ...
                        return root._viewMonth === root._todayMonth && root._viewYear === root._todayYear && Math.floor(todayTotal / 7) === weekIndex;
                    }
                    ...
                    Row {
                        ...
                        Repeater {
                            ...
                            delegate: Item {
                                ...
                                readonly property bool isToday: !isEmpty && dayNum === root._todayDay && root._viewMonth === root._todayMonth && root._viewYear === root._todayYear
