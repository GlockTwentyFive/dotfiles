...
PanelWindow {
    ...
    Connections {
        ...
        function onConnectionFailed(reason) {
            root.connectError = (reason === ConnectionFailReason.NoSecrets) ? "Wrong password" : "Connection failed";
        ...
        Column {
            ...
            Column {
                ...
                Rectangle {
                    ...
                    height: visible ? 34 : 0
                    radius: 6
                    color: activeRowMouse.containsPress && activeRowMouse.pressedButtons === Qt.RightButton ? Qt.lighter(PanelColors.network, 1.1) : PanelColors.network
                    Row {
                        anchors {
                            left: parent.left
                            leftMargin: 14
                ...
                Rectangle {
                    visible: Networking.wifiEnabled && root.wifiDevice !== null && root.wifiDevice.networks.values.some(n => n.known && !n.connected)
                    width: parent.width
                    height: visible ? 1 : 0
                    color: PanelColors.border
                }
                ...
                // 7. Other Networks
                Item {
                    visible: Networking.wifiEnabled && root.wifiDevice !== null && root.wifiDevice.networks.values.some(n => !n.known)
                    width: parent.width
            ...
            Column {
                ...
                Row {
                    ...
                    Rectangle {
                        ...
                        height: 34
                        radius: 6
                        color: cancelForgetMouse.containsMouse ? Qt.lighter(PanelColors.rowBackground, 1.15) : PanelColors.rowBackground
                        Behavior on color {
                            ColorAnimation {
                                duration: 150
                            }
                    ...
                    Rectangle {
                        ...
                        height: 34
                        radius: 6
                        color: confirmForgetMouse.containsMouse ? Qt.lighter(PanelColors.error, 1.15) : PanelColors.error
                        Behavior on color {
                            ColorAnimation {
                                duration: 150
                            }
