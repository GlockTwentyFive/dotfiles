            ...
            Item {
                ...
                Rectangle {
                    ...
                    Row {
                        anchors.centerIn: parent
                        spacing: 6
                        Text { text: "󰁞"; font.pixelSize: 12; font.family: Fonts.selectedFont; color: PanelColors.textDim }
                        Text { text: "scroll up"; font.pixelSize: 11; font.family: Fonts.selectedFont; color: PanelColors.textDim }
                    }
                }
                ...
                Rectangle {
                    ...
                    Row {
                        anchors.centerIn: parent
                        spacing: 6
                        Text { text: "󰁆"; font.pixelSize: 12; font.family: Fonts.selectedFont; color: PanelColors.textDim }
                        Text { text: "scroll for more"; font.pixelSize: 11; font.family: Fonts.selectedFont; color: PanelColors.textDim }
                    }
                }
            }
        }
        ...
        Column {
            ...
            Rectangle {
                ...
                Row {
                    anchors { left: parent.left; leftMargin: 14; verticalCenter: parent.verticalCenter }
                    spacing: 8
                    Text { text: "󰁍"; font.pixelSize: 15; font.family: Fonts.selectedFont; color: PanelColors.textMain }
                    Text { text: "Back"; font.pixelSize: 13; font.bold: true; font.family: Fonts.selectedFont; color: PanelColors.textMain }
                }
                MouseArea {
                    id: forgetBackMouse
                    anchors.fill: parent; hoverEnabled: true
            ...
            Rectangle {
                ...
                Row {
                    anchors { left: parent.left; leftMargin: 14; right: parent.right; rightMargin: 10; verticalCenter: parent.verticalCenter }
                    spacing: 8
                    Text { text: "󰤨"; font.pixelSize: 15; font.family: Fonts.selectedFont; color: PanelColors.network }
                    Text {
            ...
            Rectangle {
                ...
                Text {
                    ...
                    font.pixelSize: 11; font.family: Fonts.selectedFont
                    color: PanelColors.textDim
                }
            }
        ...
        Column {
            ...
            Rectangle {
                ...
                Row {
                    anchors { left: parent.left; leftMargin: 14; right: parent.right; rightMargin: 10; verticalCenter: parent.verticalCenter }
                    spacing: 8
                    Text { text: "󰤨"; font.pixelSize: 15; font.family: Fonts.selectedFont; color: PanelColors.pillForeground }
                    Text {
            ...
            Rectangle {
                ...
                Row {
                    anchors { left: parent.left; leftMargin: 14; right: parent.right; rightMargin: 10; verticalCenter: parent.verticalCenter }
                    spacing: 8
                    Text { text: "󰌾"; font.pixelSize: 15; font.family: Fonts.selectedFont; color: PanelColors.textDim }
                    TextInput {
                        id: pwInput
            ...
            Rectangle {
                ...
                Text {
                    ...
                    font.pixelSize: 11; font.bold: true; font.family: Fonts.selectedFont
            ...
            Rectangle {
                ...
                Row {
                    anchors.centerIn: parent
                    spacing: 8
                    Text { text: "󰤨"; font.pixelSize: 15; font.family: Fonts.selectedFont; color: root.passwordText.length > 0 ? PanelColors.pillForeground : PanelColors.textDim }
                    Text { text: "Connect"; font.pixelSize: 13; font.bold: true; font.family: Fonts.selectedFont; color: root.passwordText.length > 0 ? PanelColors.pillForeground : PanelColors.textDim }
                }
                MouseArea {
                    id: connectMouse
                    anchors.fill: parent; hoverEnabled: true
