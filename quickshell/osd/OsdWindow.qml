    ...
    Rectangle {
        ...
        RowLayout {
            ...
            Text {
                ...
                color: {
                    if (root.osdType === "brightness")
                        return PanelColors.brightness;
                    return (AudioState.muted || AudioState.volume === 0) ? PanelColors.textDim : PanelColors.audio;
                }
                text: {
                    if (root.osdType === "brightness") {
            ...
            Rectangle {
                ...
                Rectangle {
                    property real pct: root.osdType === "brightness" ? BrightnessState.brightness / 100 : Math.min(AudioState.volume, 100) / 100
