...
PopupBase {
    ...
    component RowButton: Rectangle {
        ...
        color: {
            ...
            return btnMouse.containsMouse && !btn.active && !btn.busy ? Qt.lighter(base, 1.15) : base;
        }
        Behavior on color {
            ColorAnimation {
                duration: 150
            ...
            delegate: Item {
                ...
                Rectangle {
                    ...
                    color: {
                        ...
                        return pairedMouse.containsMouse && !isConnected && !isTransitioning ? Qt.lighter(base, 1.15) : base;
                    }
                    Behavior on color {
                        ColorAnimation {
                            duration: 150
                    ...
                    Row {
                        ...
                        Text {
                            ...
                            width: parent.width - 23 - 8 - (isConnected && modelData.batteryAvailable ? 36 : 0)
                            anchors.verticalCenter: parent.verticalCenter
                        }
            ...
            Flickable {
                ...
                Column {
                    ...
                    Repeater {
                        ...
                        delegate: Item {
                            required property var modelData
                            readonly property bool show: !modelData.paired && modelData.name.trim() !== "" && !/^([0-9A-Fa-f]{2}[:\-]){5}[0-9A-Fa-f]{2}$/.test(modelData.name.trim())
                            ...
                            Rectangle {
                                ...
                                MouseArea {
                                    ...
                                    anchors.fill: parent
                                    hoverEnabled: true
                                    onClicked: if (!modelData.pairing)
                                        modelData.pair()
                                }
                            }
                        }
