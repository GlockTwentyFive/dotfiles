...
Rectangle {
    ...
    Item {
        ...
        Rectangle {
            ...
            radius: 4
            color: (rightPillMouse.containsMouse && !root.rightPillDisabled) ? (root.rightPillDestructive ? PanelColors.error : Qt.lighter(PanelColors.rowBackground, 1.15)) : PanelColors.rowBackground
            Behavior on color {
                ColorAnimation {
                    duration: 100
                }
            ...
            Text {
                ...
                font.bold: Fonts.boldFont
                font.family: Fonts.selectedFont
                color: root.rightPillDisabled ? PanelColors.textDim : root.rightPillDestructive ? (rightPillMouse.containsMouse ? PanelColors.pillForeground : PanelColors.error) : PanelColors.textMain
                Behavior on color {
                    ColorAnimation {
                        duration: 100
                    }
            ...
            MouseArea {
                ...
                onClicked: {
                    if (!root.rightPillDisabled)
                        root.rightPillClicked();
                }
            }
